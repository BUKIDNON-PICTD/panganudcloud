...
exports.create = async (req, res) => {
  try {
    ...
    if (result.length > 0) {
      ...
      const message = "FROM: covid19.bukidnon.gov.ph. SCHEDULE: " + result[0].scheddate + " 8AM to 2PM only. NAME:" + item.lastname + ", " + item.firstname + " | " + moment(item.birthdate).format('MM-DD-YYYY') + " | " + item.gender + " | " + item.prioritygroup + " | " + item.address_barangay_lguname + ", " + item.address_street;
